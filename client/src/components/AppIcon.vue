...
const ICONS = {
  ...
  wallet: [
    'M17 8V5a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H5a2 2 0 0 1-2-2V6',
    'M16 12h2',
  ],
  list: ['M9 6h11', 'M9 12h11', 'M9 18h11', 'M5 6v.01', 'M5 12v.01', 'M5 18v.01'],
  exchange: ['M3 8h14l-3 -3', 'M21 16h-14l3 3'],
  star: [
    'M12 17.75l-6.172 3.245 1.179-6.873-5-4.867 6.9-1 3.086-6.253 3.086 6.253 6.9 1-5 4.867 1.179 6.873z',
  ],
  report: [
    'M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2',
    'M9 3a2 2 0 0 0-2 2 2 2 0 0 0 2 2h6a2 2 0 0 0 2-2 2 2 0 0 0-2-2z',
    'M9 12h6',
    'M9 16h4',
  ],
  settings: [
  ...
  sun: [
    ...
    'M3 12h1M20 12h1M12 3v1M12 20v1M5.6 5.6l.7.7M18.4 5.6l-.7.7M5.6 18.4l.7-.7M18.4 18.4l-.7-.7',
  ],
  ...
  trash: [
    'M4 7h16M10 11v6M14 11v6M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2l1-12M9 7V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3',
  ],
  calendar: [
    'M4 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zM16 3v4M8 3v4M4 11h16',
  ],
  coins: [
    'M9 14m-5 0a5 5 0 1 0 10 0a5 5 0 1 0 -10 0',
    'M14.5 4.4a5 5 0 1 1 .5 9.6',
    'M9 11v6M7.5 12.5h3',
  ],
  building: [
    'M5 21V5a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v16',
    'M15 9h3a1 1 0 0 1 1 1v11',
    'M3 21h18M8 8h.01M11 8h.01M8 12h.01M11 12h.01M8 16h.01M11 16h.01',
  ],
